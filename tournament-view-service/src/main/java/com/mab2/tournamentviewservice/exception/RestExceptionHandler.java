...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ExceptionResponse> handleAllExceptions(Exception ex, WebRequest req) {
		...
		var exceptionResponse = new ExceptionResponse(new Date(), req.getDescription(false), ex.getMessage());
	...
	public final ResponseEntity<ExceptionResponse> handleBadRequestExceptions(BadRequestException ex, WebRequest req) {
		
		var exceptionResponse = new ExceptionResponse(new Date(), req.getDescription(false), ex.getErrors());
		return new ResponseEntity<ExceptionResponse>(exceptionResponse, HttpStatus.BAD_REQUEST);
	...
	protected ResponseEntity<Object> handleMethodArgumentNotValid(
		...
		var exceptionResponse = new ExceptionResponse(new Date(), "Validation errors", errors);
